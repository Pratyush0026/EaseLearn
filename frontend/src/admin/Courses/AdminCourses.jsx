...
const enrollmentStatuses = ["Open", "Closed", "In Progress"];
...
const AdminCourses = ({ user }) => {
  ...
  const submitHandler = async (e) => {
    ...
    myForm.append("createdBy", createdBy);
    myForm.append("duration", duration);
    myForm.append("enrollmentStatus", enrollmentStatus);
    myForm.append("schedule", schedule);
    myForm.append("location", location);
    myForm.append("prerequisites", prerequisites);
    myForm.append("syllabus", syllabus.split(','));
    myForm.append("file", image);
          ...
          <div className="add-course">
            <div className="course-form">
              ...
              <form onSubmit={submitHandler}>
                ...
                <input type="file" required onChange={changeImageHandler} />
                {imagePrev && <img src={imagePrev} alt="Course" width={300} />}
